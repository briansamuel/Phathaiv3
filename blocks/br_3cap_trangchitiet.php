...
<nav id="breadcumds">
    <ul xmlns:v="http://rdf.data-vocabulary.org/#">
      <li typeof="v:Breadcrumb"><a href="." rel="v:url" property="v:title"><span>Trang chủ</span></a></li> /
        <?php if($idOng>0){ ?>
        <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
          <a href="<?php echo $TenLoaiOngKD; ?>/" itemprop="url">
            <?php echo $TenLoaiOng; ?></a> 
        </li> /
        <?php } ?>
        <?php if($idCha > 0){ ?>
          <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
            <a href="<?php echo $TenLoaiChaKD; ?>/" itemprop="url">
              <?php echo $TenLoaiCha; ?></a> 
          </li> /
        <?php } ?>
        <?php if($idCon > 0){ ?>
          <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
            <a href="<?php echo $TenLoaiConKD; ?>/" itemprop="url">
              <?php echo $TenLoaiCon; ?></a>
          </li> /
        <?php } ?>
      <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
         
            <span itemprop="title"><?=$row['TieuDe'];?></span>
      </li>
    </ul>
</nav>