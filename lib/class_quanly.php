	...
	public function LienHe4($ghichu)
	{
		...
		else
		{
			...
			$sql="INSERT INTO `sodienthoai` (				
					...
					VALUES ('".$sdt1."',  '".gmdate("Y-m-d H:i:s",time()+7*3600)."','".$this->getClientIP()."','".$ghichu."');";
			 mysql_query($sql);
			 
			$bodymail = '<table style=" font-family: arial, sans-serif;
    border-collapse: collapse;
    width: 100%;">
  <tr>
    <th style=" border: 1px solid #dddddd;
    text-align: left;
    padding: 8px;">Ngày giờ</th>
    <th style=" border: 1px solid #dddddd;
    text-align: left;
    padding: 8px;">SĐT</th>
    <th style=" border: 1px solid #dddddd;
    text-align: left;
    padding: 8px;">Link web</th>
    <th style=" border: 1px solid #dddddd;
    text-align: left;
    padding: 8px;">IP</th>
    <th style=" border: 1px solid #dddddd;
    text-align: left;
    padding: 8px;">Ghi chú</th>
  </tr><tr>
    <td style=" border: 1px solid #dddddd;
    text-align: left;background-color: #dddddd;
    padding: 8px;">'.date("Y-m-d H:i:s",time() + 28800).'</td>

    <td style=" border: 1px solid #dddddd;
    text-align: left;
    padding: 8px;background-color: #dddddd;">'.$sdt.'</td>
    <td style=" border: 1px solid #dddddd;
    text-align: left;
    padding: 8px;background-color: #dddddd;">'.$sdt1.'</td>
    <td style=" border: 1px solid #dddddd;
    text-align: left;background-color: #dddddd;
    padding: 8px;">'.$this->getClientIP().'</td>
    <td style=" border: 1px solid #dddddd;
    text-align: left;
    padding: 8px;background-color: #dddddd;">'.$ghichu.'</td>
  </tr></table>';

			$mail = sendMail('Thông báo có sđt mới',$bodymail, 'System Notification', array('498673573@qq.com','497535432@qq.com'),$diachicc='');
