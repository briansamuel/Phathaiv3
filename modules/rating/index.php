...
<style type="text/css">
    .line-head-post {
        ...
        background: rgba(255, 134, 118, 0.2);
    }
    .left-lhp {
        width: 50%;
        float: left;
...
<div class="line-head-post">
    ...
    <!-- Go to www.addthis.com/dashboard to customize your tools --> <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-54574d6f1e325dec"></script>
    </div>
    <div class="right-lhp">
        <span>Ngày đăng <?php echo $time_post; ?> - Lượt xem <?php echo $row['LuotXem']; ?></span>
    </div>
</div>
